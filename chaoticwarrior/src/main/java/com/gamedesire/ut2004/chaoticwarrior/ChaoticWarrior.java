package com.gamedesire.ut2004.chaoticwarrior;
 ...
 */
@AgentScoped
public class ChaoticWarrior extends UT2004BotModuleController<UT2004Bot> {
    ...
    public Initialize getInitializeCommand() {
        ...
        return new Initialize().setName("ChaoticWarrior #" + (++instanceCount)).setDesiredSkill(5);
    }
     ...
     * time is not visible than choose new enemy <li> if enemy is reachable and
     * the bot is far - run to him <li> otherwise - stand still (kind a silly,
     * right? :-) </ol>
     */
    protected void stateEngage() {
        ...
        if (!enemy.isVisible() || !shooting || decentDistance < distance) {
            ...
            int chaoticDecision = getRandom().nextInt(4);
            switch (chaoticDecision) {
                case 0:
